      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#224f3c] mb-3">
                Full Name
              </label>
              <input
                id="name"
        ...
        <div className="text-center">
          <p className="text-sm text-[#224f3c]/70">
            ...
            <Link to="/login" className="font-medium text-[#00ce78] hover:text-[#00ce78]/80 transition-colors duration-200">
              Sign in here
            </Link>
          </p>
        </div>
